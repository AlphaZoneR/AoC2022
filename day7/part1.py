...
# as the expedition proceeds. Occasionally, you can even hear much louder sounds in the distance;
...
def is_directory_and_smaller_than_builder(size_limit: int) -> typing.Callable:
...
matching_folders = fs.nodes_matching(
    is_directory_and_smaller_than_builder(100000))

print(sum(node.size for node in matching_folders))
