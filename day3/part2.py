...
grouped_components = [(set([*component[0]]), set([*component[1]]), set([*component[2]])) for component in grouped_components]
overlaps = [component[0] & component[1] & component[2]  for component in grouped_components]
