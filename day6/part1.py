# --- Day 6: Tuning Trouble ---The preparations are finally complete; you and the Elves leave
...
# should report the value 7, because the first start-of-packet marker is complete after 7 characters
# have been processed.
